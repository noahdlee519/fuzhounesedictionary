...
const en = {
  ...
  "footer.blurb.trust": "A collaborative project to document, preserve, and teach Fuzhounese. For now, recordings go live straight away and are checked afterwards; everything else is reviewed before it appears.",
  ...
  "hub.lede.trust": "Record, add, improve, and request words quickly and easily. For now, recordings go live the moment you save them and an editor checks them afterwards; everything else is read by an editor before it goes live.",
  ...
  "about.built.2.trust": "Every word and edit is read by an editor before it appears. For now, recordings go live straight away and an editor listens to them afterwards.",
...
const zh: Record<Key, string> = {
  ...
  "footer.blurb.trust": "一個記錄、保存與教授福州話的共同計畫。目前錄音會直接上線，之後再審核；其他貢獻經審核後才會刊出。",
  ...
  "hub.lede.trust": "錄音、新增、完善、請求，每一步都快而直接。目前錄音一儲存就會上線，之後由編輯複查；其他貢獻都先經編輯審閱才會刊出。",
  ...
  "about.built.2.trust": "每個詞、每次修改，都先經編輯審閱才會刊出。目前錄音會直接上線，之後由編輯再聽一次。",
