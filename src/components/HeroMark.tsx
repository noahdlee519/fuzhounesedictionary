...
export default function HeroMark() {
  return (
    <span
      aria-hidden="true"
      lang="zh-Hant"
      className="han pointer-events-none absolute -z-10 -right-2 top-12 select-none whitespace-nowrap text-[clamp(72px,11vw,150px)] font-bold leading-none text-ink opacity-[.05] max-[760px]:top-2 max-[760px]:opacity-[.035]"
    >
      福州話
    </span>
  );
